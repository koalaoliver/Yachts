...
{
    public partial class yacht_master : System.Web.UI.MasterPage
    {
        ...
        private void loadTopMenu()
        {
            ...
            if (reader.Read())
            {
                ...
                string youtubeUrl = reader["youtubeUrl"].ToString();
                ...
                {
                    // 如果 youtubeUrl 有数据，则添加 Video 链接
                    topMenuHtmlStr.Append($"<li><a class='menu_yli04' href='Yachts_Video.aspx?id={guidStr}' >Video</a></li>");
                }
        ...
        private void loadGallery()
        {
            ...
            if (reader.Read())
            {
                ...
                {
                    //逐一填入圖片路徑欄位值
                    dataTable.Rows.Add($"upload/yachts/{item.SavePath}");
                }
            }
            connection.Close();
